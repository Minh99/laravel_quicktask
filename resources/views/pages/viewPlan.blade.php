...
<div class="col-sm">
    ...
    <h3 class="text-center">@lang('Plans')</h3>
    @if(session("status"))
            ...
            <form action="{{route('plan.createOrUpdate')}}" method="POST">
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <label class="input-group-text" for="inputGroupSelect01">@lang('Choose') @lang('Task')</label>
                    </div>
        ...
        <div class="col-12 col-md-8">
            <table class="table  table-striped ">
                <thead class="thead-light">
                    <tr>
                        <th scope="col">ID @lang('Plan')</th>
                        <th scope="col">@lang('Name') @lang('Task')</th>
                        <th scope="col">@lang('Members')</th>
                    </tr>
                </thead>
                <tbody>
